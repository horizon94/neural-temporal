...
EvaluationOfTemporalRelations_ImplBase{
	...
	public static void main(String[] args) throws Exception {
		...
		try{
			...
			NeuralEventTimeRelationsCNNEvaluation evaluation = new NeuralEventTimeRelationsCNNEvaluation(
					workingDir,
	...
	public NeuralEventTimeRelationsCNNEvaluation(
			File baseDirectory,
...
//			aggregateBuilder.add(AnalysisEngineFactory.createEngineDescription(RemoveNonContainsRelations.class));
			...
			aggregateBuilder.add(
					AnalysisEngineFactory.createEngineDescription(EventTimeCNNAnnotator.class,
