...
import org.chboston.cnlp.temporal.neural.DocTimeRelCNNAnnotator;
	...
	protected void train(CollectionReader collectionReader, File directory) throws Exception {
		...
		if(!this.skipWrite){
			...
			aggregateBuilder.add(
					AnalysisEngineFactory.createEngineDescription(DocTimeRelCNNAnnotator.class,
		...
		JarClassifierBuilder.trainAndPackage(new File(directory, DOC_TIME_REL));
	}
	...
	protected Map<String, AnnotationStatistics<String>> test(CollectionReader collectionReader, File directory)
		...
		aggregateBuilder.add(
				AnalysisEngineFactory.createEngineDescription(DocTimeRelCNNAnnotator.class,
						...
						new File(new File(directory,DOC_TIME_REL), "model.jar").getPath()));
